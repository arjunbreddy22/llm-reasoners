...
def mcts_tot_game24(base_model: LanguageModel,
                    prompts: dict,
    ...
    search_algo_params |= {'output_trace_in_each_iter': True, 'depth_limit': depth_limit, 'disable_tqdm': False, 'n_iters': 10}
...
if __name__ == '__main__':
    ...
    def main(base_lm: Literal['llama', 'llama.cpp', 'llama-2', 'hf', 'exllama','llama-3', 'sglang'] = 'llama-2',
        ...
        if base_lm == 'llama':
            ...
            base_model = SGLangModel(sglang_model, max_new_tokens=512, is_instruct_model=True)
        else:
